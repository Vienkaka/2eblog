...
date: '2023-06-19'
lastmod: '2023-06-19'
tags: ['nestjs', 'testing', 'project-structure', 'backend', 'typescript']
draft: false
summary: 'Để dễ dàng quản lý và sử dụng các thành phần trong NestJs chúng ta cần phải có cấu trúc thư mục dễ sử dụng'
images:
  [
    'https://fastly.picsum.photos/id/955/3872/2592.jpg?hmac=9Qkf5jGvEI5yx50cewZwqHpYnLlsAYq1vOfntqduFPo',
  ]
authors: ['default']
layout: PostLayout
canonicalUrl: https://gaoden.vercel.app/blog/cau-truc-thu-muc-nestjs-va-testing-voi-duong-dan-tuyet-doi
---
...
![Hình ảnh cấu trúc thư mục NestJS](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/affiliate/cource/Screen%20Shot%202023-06-19%20at%2021.35.43.png)
...
![Cấu trúc file trong src](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/affiliate/cource/Screen%20Shot%202023-06-19%20at%2021.52.45.png)
...
![Đường dẫn tuyệt đối](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/affiliate/cource/Screen%20Shot%202023-06-20%20at%2008.48.56.png)
