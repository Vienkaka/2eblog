...
date: '2023-07-02'
lastmod: '2023-07-02'
tags: ['nestjs', 'tutorial', 'backend', 'nodejs', 'typescript']
draft: false
...
authors: ['default']
layout: PostLayout
canonicalUrl: https://gaoden.vercel.app/blog/nest-ung-dung-dau-tien
---
...
![NestJs cấu trúc thư mục](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/post/nestjs-ung-dung-dau-tien)
