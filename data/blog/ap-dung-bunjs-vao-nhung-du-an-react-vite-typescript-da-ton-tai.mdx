...
date: '2023-12-03'
lastmod: '2023-12-03'
tags: ['reactjs', 'bun', 'javascript', 'typescript', 'vite']
draft: false
...
authors: ['default']
layout: PostLayout
canonicalUrl: https://gaoden.vercel.app/blog/ap-dung-bunjs-vao-nhung-du-an-react-vite-typescript-da-ton-tai
---
...
![post-25](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/post/bun)
...
![](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/post/bun-install)

Trong dự án của mình sử dụng yarn nên mình sẽ test thử.

**yarn**
![post-50](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/post/yarn-install)

**bun install**
![post-50](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/post/bun-install-script)
...
![post-50](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/post/bun-build-compare?t=2023-12-03T09%3A03%3A14.463Z)
