...
date: 2023-05-26T22:32:14Z
tags: ['Javascript', 'interview']
draft: false
summary: 'Hôm nay mình xin chia sẻ nội dung về các cuộc phỏng vấn, lý do là do kinh tết suy thoái, thị trường tuyển dụng ảm đạm, sa thải hoàng loạt nhân viên với số lượng lớn ở các ngành công nghiệp và trong ngành công nghệ thông tin các lập trình viên cũng chịu ảnh hưởng đôi phần. Thông qua 1 số trang thống kê về độ chính xác trong các câu hỏi về ngôn ngữ lập trình thì mình muốn chia sẻ 1 vài thông tin về javascript cho các bạn đang trong thời gian tìm việc với nội dung được thống kê là hầu hết các bạn đều sai với những câu hỏi javascript.'
layout: PostSimple
...
hỏi javascript. ## Dẫn dắt Thình thoảng bạn tham gia các cuộc phỏng vấn Javascript thì bạn sẽ thấy được
...
dưới đây: ## Event loop ### Độ chính xác 18% ```jsx setTimeout(() => console.log(1), 0);
