---
title: 'Áp dụng bun vào những dự án react typescript sử dụng vite đã có sẳn'
...
Như vậy thì khi áp dụng bun vào dự án react,vite, typescript đã có sẳn thì tối ưu được thời gian install, nhưng việc install toàn bộ package trong 1 dự án là ít khi sảy ra.
