...
date: '2023-06-23'
lastmod: '2023-06-23'
tags: ['postman', 'testing', 'automation', 'script', 'api']
draft: false
...
authors: ['default']
layout: PostLayout
canonicalUrl: https://gaoden.vercel.app/blog/postman-viet-test-voi-script
---
...
![Testing trong postman](https://hksbjaideaoctdqnkzug.supabase.co/storage/v1/object/public/post/postman-script?t=2023-06-24T10%3A58%3A02.546Z)
